...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    let categories = [
        AnimalCategory(category: "포유류", animals: [
            Animal(name: "사자", image: UIImage(systemName: "pawprint.fill")!),
            Animal(name: "호랑이", image: UIImage(systemName: "pawprint.fill")!),
            Animal(name: "곰", image: UIImage(systemName: "pawprint.fill")!)
        ]),
        AnimalCategory(category: "조류", animals: [
            Animal(name: "독수리", image: UIImage(systemName: "bird.fill")!),
            Animal(name: "부엉이", image: UIImage(systemName: "bird.fill")!),
            Animal(name: "참새", image: UIImage(systemName: "bird.fill")!)
        ]),
    ]
